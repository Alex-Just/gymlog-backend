...
MIGRATION_MODULES = {"sites": "gymlog.contrib.sites.migrations"}
...
ADMINS = [("""AlekseiK""", "alex@example.com")]
...
ACCOUNT_FORMS = {"signup": "gymlog.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "gymlog.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "gymlog.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "gymlog API",
    "DESCRIPTION": "Documentation of API endpoints of gymlog",
    "VERSION": "1.0.0",
